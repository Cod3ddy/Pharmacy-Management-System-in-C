...
void customerMenu(){
	...
	char space [3] = " ";
	strcat(customerName, ctm.firstName);
	strcat(customerName, space);
	strcat(customerName, ctm.surname);
	
	setWindowState(customerName);
...
void buyDrugs(){
	...
	buy = fopen("files/pharmacy.txt", "rb+");
...
//transaction details		
		buy = fopen("files/pharmacy.txt", "rb+");	
		purchaseRecord = fopen("files/transactionHistory.txt", "ab+");
...
//					calculate total amount to pay
					...
					switch(checkOut){
						case 1:{
							...
							fwrite(&d, sizeof(d), 1, buy);
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::								
//							inserting customer payment details in the file
